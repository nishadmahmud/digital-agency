    ...
    <header className="sticky top-0 z-50 border-b border-white/10 bg-bg-deep/80 backdrop-blur-xl supports-[backdrop-filter]:bg-bg-deep/65">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex shrink-0 items-center gap-3">
          <a
            href="#contact"
            className="rounded-xl bg-accent-green px-3 py-2 text-xs font-semibold text-white shadow-lg shadow-accent-green/20 transition hover:-translate-y-0.5 hover:shadow-accent-green/35 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-green sm:px-4 sm:py-2.5 sm:text-sm"
          >
            {nav.cta}
          </a>
        </div>
