    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {portfolioGrid.items.map((item) => (
            <article
              key={item.title}
              className="group flex flex-col overflow-hidden rounded-2xl border border-slate-200/90 bg-white shadow-md shadow-slate-900/10 ring-1 ring-slate-900/[0.04] transition hover:-translate-y-0.5 hover:shadow-xl"
            >
