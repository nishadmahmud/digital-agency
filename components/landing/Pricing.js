      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-16 grid gap-8 lg:grid-cols-3">
          {pricingContent.plans.map((plan) => (
            <div
              key={plan.id}
              className={`relative flex flex-col rounded-3xl border bg-gradient-to-b from-white/[0.06] to-transparent p-8 shadow-xl shadow-black/30 ${
                plan.featured
            ...
            >
              ...
              <a
                href="#contact"
                className={`mt-10 inline-flex w-full items-center justify-center rounded-2xl py-3.5 text-center text-sm font-semibold text-white transition hover:-translate-y-0.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${
